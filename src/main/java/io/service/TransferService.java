...
public class TransferService {
    ...
    private volatile AtomicInteger numOfTransfer = new AtomicInteger();
    /*private static final long ONE_SECONDS = 1L;*/

    public void transferStart(Account accountOne, Account accountTwo, long countMoney, int maxTransfer) throws InterruptedException {
        /*Thread.sleep(500);*/
        if (numOfTransfer.get() < maxTransfer) {
            lock.lock();
